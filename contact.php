...
<!-- navbar end -->
  ...
  <section class="main-contant-section py-">
      ...
      <div class="row justify-content-center">
         <div class="col-lg-8">
           <div class="card card-body border-10 shadow">
               <div class="row">
                <div class="col-lg-4">
                    <div class="card py- card-body card-contact bg-theme">
                      <h1>Contact Us</h1>
                      <div class="media mb-5 align-item-center">
                         <div class="icon-part  mr-3">
                          <i class="fa fa-map-marker"></i>
                         </div>
                        
                        <div class="media-body">
                          <h5 class="mt-">Gulshan-e-Iqbal</h5>
                        </div>
                      </div>
                      <div class="media mb-5 align-item-center">
                        <div class="icon-part  mr-3">
                       ...
                       <div class="media-body">
                         <h5 class="mt-2">+92 337-8071580</h5>
                       </div>
                     </div>
                     <div class="media mb-5 align-item-center">
                      <div class="icon-part  mr-3">
                     ...
                     <div class="media-body">
                       <h5 class="mt-2">Shoppingcart@gmail.com</h5>
                     </div>
                   </div>
                    </div>
                </div>
                 <div class="col-lg-6 cardd">
                  <form method="post">
                    <div class="form-group">
                      <label>Name</label>
                      <input type="text" name="to" class="form-control" Required placeholder="Enter your name">
                    </div>
                    <div class="form-group">
                      <label>Subject</label>
                      <input type="text" name="subject" class="form-control" Required placeholder="Your message!">
                    </div>
                    <div class="form-group">
                      <label>Email</label>
                      <input type="email" name="msg" class="form-control" Required                                                                   placeholder="Enter your email">
                    </div>
                    <button type="submit" name="btnsub " class="btn">Submit</button>
                  </form>
                 </div>
               </div>
           </div>
...
<?php
        if(isset ($_POST['btnsub']))
        {
            ...
            if(mail($to,$sub,$msg,"zark.khan000@gmail.com")){
