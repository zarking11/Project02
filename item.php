...
<!-- navbar end -->
       ...
       <!--pack of stationary items-->
  <div class="container my-5">

<div class="row">
  <div class="col-md-12 text-center mb-5">
    <h2><i>Pack of stationary items</i></h2>
  </div>
</div>
...
<div class="row">
  <div class="col-md-4 " id="item">
    <div class="card mb-4 box-shadow">
      <img class="card-img-top" src="menswear/shirts/tshirt1.png" alt="Card image cap">
      <div class="card-body">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <div class="btn-group">
          <a href="blackshirt.html">
            <button type="button" class="btn btn-sm btn-outline-primary mx-2 px-4"><i
              class="fa-solid fa-cart-shopping"></i>&nbsp; Add to cart</button>
          </a>
          </div>
          <small class="text-success"><b>In stock</b></small>
        </div>
      </div>
    </div>
  </div>
  <div class="col-md-4" id="item">
    <div class="card mb-4 box-shadow">
      <img class="card-img-top" src="menswear/shirts/shirt2.png" alt="Card image cap">
      <div class="card-body">
        <small class="text-success">
          <h5>$35.00</h5>
        </small>
  ...
  <div class="col-md-4" id="item">
    <div class="card mb-4 box-shadow">
      <img class="card-img-top" src="menswear/shirts/shirt12.webp" alt="Card image cap">
      <div class="card-body">
        <small class="text-success">
          <h5>$38.00</h5>
        </small>
        <p>
        <h5>Colorfull Shirt</h5>
        </p>
        <div class="d-flex justify-content-between align-items-center">
          <div class="btn-group">
